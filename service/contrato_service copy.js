...
async function storeContrato(contr, arr_c, arr_s) {
    ...
    //     var id_contr = (result_id == 0 ? id_url : result_id)

    //     if (arr_s != '') {
    //         updateBem_null(arr_s)
    //     }

    //     if (arr_c != '') {
    //         updateBem_to_on(id_contr, arr_c)
    //     }

    // }
}

// ATUALIZA BEM PARA O CONTRATO
// function updateBem_to_on(id_contr, arr_c) {
//     const response = fetch('../controller/contrato_controller.php', {
//         method: 'POST',
//         headers: {
//             'Accept': 'application/json',
//             'Content-Type': 'application/x-www-form-urlencoded',
//         },
//         body: 'func=cont_c&contr=&arr_c=' + arr_c + '&id_contr=' + id_contr
//     })
...
//                     if (result) {
//                         $("#loader").hide();
//                         erroUpdateBem(result)
//                     }
//                 })
//         })
// }

//ATUALIZA BEM PRA NULL
// function updateBem_null(arr_s) {
//     const response = fetch('../controller/contrato_controller.php', {
//         method: 'POST',
//         headers: {
//             'Accept': 'application/json',
