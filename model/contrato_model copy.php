...
class Contrato extends config
{
    ...
    public function updateBem_s($id_c)
    {
        try {
    ...
    public function updateBem_c($id_c, $cont_c)
    {
        try {
            $sql = "UPDATE `bem` SET  `contrato`= ?  WHERE id = ?";
            $stmt = $this->pdo->prepare($sql);
            $stmt->execute([$cont_c, $id_c]);
    ...
    public function insertFormContrato($descontoIntegral, $descontoPosterior, $mapa, $valorDescontoMapa, $descontoMapa, $inicioPagamento, $tipoContr, $id_cliente)
    {
        try {
    ...
    public function updateFormContrato($descontoIntegral, $descontoPosterior, $mapa, $valorDescontoMapa, $descontoMapa, $inicioPagamento, $fimPagamento = null, $tipoContr, $id_cliente, $id_contr)
    {
        try {
            $sql = "UPDATE `contrato` 
